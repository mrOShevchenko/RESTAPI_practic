...
func (_m *UserRepo) FindByEmail(email string) (models.User, error) {
	ret := _m.Called(email)
...
func (_m *UserRepo) FindByID(id int64) (models.User, error) {
	ret := _m.Called(id)
...
func (_m *UserRepo) Save(user models.User) (models.User, error) {
	ret := _m.Called(user)
